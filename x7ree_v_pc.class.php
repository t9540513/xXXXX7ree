...
class plugin_x7ree_v {
	...
	function  post_editorctrl_left_output(){
		...
		if(!$vars_7ree['agreement_7ree'] || !$vars_7ree['media_7ree']){
			return $return;
		}


		include template("x7ree_v:editor_ctrl_7ree");
		return $return;
	}
...
class plugin_x7ree_v_forum extends plugin_x7ree_v {
}
class plugin_x7ree_v_home extends plugin_x7ree_v {
}
class plugin_x7ree_v_portal extends plugin_x7ree_v {
}
?>